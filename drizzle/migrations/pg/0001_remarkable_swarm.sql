CREATE INDEX "idx_audit_log_spec_name" ON "audit_log" USING btree ("spec_name");--> statement-breakpoint
...
CREATE INDEX "idx_spec_versions_semver" ON "spec_versions" USING btree ("spec_id","semver");